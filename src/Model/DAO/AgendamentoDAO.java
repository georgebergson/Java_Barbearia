...
public class AgendamentoDAO {
     ...
     */
    public void insert(AgendamentoModel agendamento){
     ...
     * @return 
     */
    public boolean update(AgendamentoModel agendamento){
     ...
     * @return 
     */
    public boolean delete(AgendamentoModel agendamento){
        for (AgendamentoModel agendamentoLista : Banco.agendamento) {
     ...
     */
    private boolean idSaoIguais(AgendamentoModel agendamento, AgendamentoModel agendamentoAComparar) {
    ...
    private int proximoId(){
        ...
        for (AgendamentoModel agendamento : Banco.agendamento) {           
